...
#
# Script generated by Vivado on Thu Apr 02 14:22:40 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dram_ip_8bit.sh
...
#
# Usage        : dram_ip_8bit.sh
#                dram_ip_8bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dram_ip_8bit.sh [-reset_run]
#                dram_ip_8bit.sh [-reset_log]
#                dram_ip_8bit.sh [-help]
#
...
#                script (type 'dram_ip_8bit.sh -help' for more information).
#
...
# script info
echo -e "dram_ip_8bit.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dram_ip_8bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dram_ip_8bit xil_defaultlib.glbl -o dram_ip_8bit_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dram_ip_8bit_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dram_ip_8bit_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dram_ip_8bit_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dram_ip_8bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dram_ip_8bit.sh [-help]\n\
Usage: dram_ip_8bit.sh [-step]\n\
Usage: dram_ip_8bit.sh [-lib_map_path]\n\
Usage: dram_ip_8bit.sh [-reset_run]\n\
Usage: dram_ip_8bit.sh [-reset_log]\n\
Usage: dram_ip_8bit.sh [-keep_index]\n\
Usage: dram_ip_8bit.sh [-noclean_files]\n\n\
