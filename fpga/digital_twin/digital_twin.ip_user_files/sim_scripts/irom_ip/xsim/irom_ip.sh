...
#
# Script generated by Vivado on Thu Apr 02 14:21:05 +0800 2026
...
#
# Usage        : irom_ip.sh
#                irom_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                irom_ip.sh [-reset_run]
#                irom_ip.sh [-reset_log]
#                irom_ip.sh [-help]
#
...
# script info
echo -e "irom_ip.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./irom_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot irom_ip xil_defaultlib.irom_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim irom_ip -key {Behavioral:sim_1:Functional:irom_ip} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb irom_ip.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./irom_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: irom_ip.sh [-help]\n\
Usage: irom_ip.sh [-step]\n\
Usage: irom_ip.sh [-lib_map_path]\n\
Usage: irom_ip.sh [-reset_run]\n\
Usage: irom_ip.sh [-reset_log]\n\
Usage: irom_ip.sh [-keep_index]\n\
Usage: irom_ip.sh [-noclean_files]\n\n\
