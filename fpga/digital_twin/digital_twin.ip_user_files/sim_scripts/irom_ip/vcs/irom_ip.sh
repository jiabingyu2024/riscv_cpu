...
#                script (type 'irom_ip.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.irom_ip xil_defaultlib.glbl -o irom_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./irom_ip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key irom_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc irom_ip_simv.daidir vcs_lib c.obj)
