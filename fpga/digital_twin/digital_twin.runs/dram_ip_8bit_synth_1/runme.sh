...
HD_PWD='D:/jichuang/fpga/digital_twin/digital_twin.runs/dram_ip_8bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dram_ip_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dram_ip_8bit.tcl
