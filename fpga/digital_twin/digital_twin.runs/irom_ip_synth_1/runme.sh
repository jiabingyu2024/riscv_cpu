...
HD_PWD='D:/jichuang/fpga/digital_twin/digital_twin.runs/irom_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log irom_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source irom_ip.tcl
