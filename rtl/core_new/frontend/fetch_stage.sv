...
module core_new_fetch_stage (
    ...
    assign branch_imm = {{19{i_irom_data[31]}}, i_irom_data[31], i_irom_data[7], i_irom_data[30:25], i_irom_data[11:8], 1'b0};
    ...
    always_comb begin
        ...
        if (i_valid) begin
            o_pred_target = i_pred_valid ? i_pred_target : static_target;
        end else begin
            o_pred_target = '0;
        end
        o_valid       = i_valid;
