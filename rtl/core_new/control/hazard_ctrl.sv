...
module core_new_hazard_ctrl (
    ...
    input  logic           i_id_use_rs1,
    input  logic           i_id_use_rs2,
    ...
    assign hit_ex = i_ex_mem_read && (i_ex_rd != '0) &&
                    ((i_id_use_rs1 && (i_ex_rd == i_id_rs1)) ||
                     (i_id_use_rs2 && (i_ex_rd == i_id_rs2)));
    assign hit_m1 = i_m1_mem_read && (i_m1_rd != '0) &&
                    ((i_id_use_rs1 && (i_m1_rd == i_id_rs1)) ||
                     (i_id_use_rs2 && (i_m1_rd == i_id_rs2)));
