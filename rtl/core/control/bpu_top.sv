...
module bpu_top (
    ...
    logic [1:0]           bht_mem     [0:BPU_ENTRIES-1];
    ...
    always_ff @(posedge i_clk or negedge i_rst_n) begin
        if (!i_rst_n) begin
            ...
            if (i_update_taken) begin
                ...
                if (bht_mem[wr_idx] != 2'b11) begin
                    bht_mem[wr_idx] <= bht_mem[wr_idx] + 2'b01;
                end
            end else if (bht_mem[wr_idx] != 2'b00) begin
                bht_mem[wr_idx] <= bht_mem[wr_idx] - 2'b01;
            end
        end
    end
    ...
    always_comb begin
        o_predict_taken  = btb_hit && bht_mem[rd_idx][1];
