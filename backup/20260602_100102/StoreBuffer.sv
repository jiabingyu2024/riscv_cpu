...
module StoreBuffer(
    ...
    always_comb begin
        ...
        if (self.StoreBufferCommitReq.valid &&
            ...
            dram.writeEn = 1'b1;
            dram.accessAddr = self.StoreBufferCommit.addr;
            dram.writeData = self.StoreBufferCommit.data;
            dram.writeMask = self.StoreBufferCommit.wstrb;
            self.StoreBufferCommitReady = dram.accessReady;
        end
